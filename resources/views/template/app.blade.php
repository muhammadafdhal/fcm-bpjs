    ...
    <nav class="navbar navbar-expand-sm navbar-default">
        ...
        <div id="main-menu" class="main-menu collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li>
                    <a href="{{('data')}}"> <i class="menu-icon fa fa-dashboard"></i>Data </a>
                </li>
                <li>
                    <a href="{{('dataset')}}"> <i class="menu-icon fa fa-dashboard"></i>Dataset </a>
                </li>
                <li>
                    <a href="{{('perhitungan')}}"> <i class="menu-icon fa fa-dashboard"></i>Perhitungan </a>
                </li>
                <li>
                    <a href="{{('pengujian')}}"> <i class="menu-icon fa fa-dashboard"></i>Pengujian </a>
                </li>
                8
