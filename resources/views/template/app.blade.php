...
<aside id="left-panel" class="left-panel">
    <nav class="navbar navbar-expand-sm navbar-default">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="../layouts"><img src="template/images/logo.png" alt="Logo"></a>
        ...
        <div id="main-menu" class="main-menu collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li>
                    <a href="index.html"> <i class="menu-icon fa fa-dashboard"></i>Data </a>
                </li>
                <li>
                    <a href="index.html"> <i class="menu-icon fa fa-dashboard"></i>Dataset </a>
                </li>
                <li>
                    <a href="index.html"> <i class="menu-icon fa fa-dashboard"></i>Perhitungan </a>
                </li>
                <li>
                    <a href="index.html"> <i class="menu-icon fa fa-dashboard"></i>Pengujian </a>
                </li>
...
{{--                </li>--}}
{{--                <li class="menu-aditem-has-children dropdown">--}}
{{--                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true"--}}
